...
const Product = ({ product }) => {
    ...
    return (
        <div className="p-6 flex flex-col justify-between gap-4 border-2 border-[#f2f2f2] rounded-2xl">
            ...
            <button className="btn bg-linear-to-r from-[#4F39F6] to-[#9514FA] font-bold text-white rounded-full">Buy Now</button>
        </div>
    );
};
